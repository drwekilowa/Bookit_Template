...
public class Environment {
    ...
    static{
        ...
        try {
            ...
            //System.getProperty("user.dir") gets the current working directory of the project.
            // Paths.get() for better handling of file paths across different operating systems.
            //System.getProperty("user.dir") gets the current working directory of the project.
...
//                    "src", "test", "resources", "Environments", environment + ".properties").toString();
